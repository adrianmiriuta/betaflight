...
// PG_GYRO_CONFIG
    ...
    { "gyro_offset_roll",           VAR_INT16 | MASTER_VALUE, .config.minmax = { -1000, 1000 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, gyro_offset_roll) },
    { "gyro_offset_pitch",          VAR_INT16 | MASTER_VALUE, .config.minmax = { -1000, 1000 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, gyro_offset_pitch) },
